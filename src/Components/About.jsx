...
function About() {
  return (
      ...
      <div id='About' className='lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg-text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center'>
       <img data-aos="fade-down" src={img} width={290} height={290} className='rounded border-2 p-1 border-fuchsia-500 img-glow' alt="" />
      ...
      <p data-aos="fade-left">Lorem, ipsum dolor sit amet consectetur adipisicing elit</p>
